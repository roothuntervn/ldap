<?php
    ...
    $filter = "(&(objectClass=person)(!(ou=CEO)))";
    $regex = '/[()*&|!=><~]/';
    if (isset($_GET['search']) && !preg_match($regex, $_GET['search'])) {
        $search = urldecode($_GET['search']);
        $filter = "(&(objectClass=person)(&(givenName=" .$search. ")(!(ou=CEO))))";
    }
...
<html>
    <head> <title>RootHunter Company </title>
        ...
        <nav class="navbar navbar-inverse">
            <div class="containter-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="/"> RootHunter Company </a>
                </div>
            </div>
